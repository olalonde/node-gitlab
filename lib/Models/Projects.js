(function() {
  var BaseModel, Projects, Utils, nop,
  ...
  Projects = (function(superClass) {
    ...
    Projects.prototype.share = function(params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(params.projectId)) + "/share", params, fn);
    };
    ...
    Projects.prototype.listTriggers = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/triggers", fn);
    };
    ...
    Projects.prototype.showTrigger = function(projectId, token, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/triggers/" + token, fn);
    };
    ...
    Projects.prototype.createTrigger = function(params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(params.projectId)) + "/triggers", params, fn);
    };
    ...
    Projects.prototype.removeTrigger = function(projectId, token, fn) {
      ...
      return this["delete"]("projects/" + (Utils.parseProjectId(projectId)) + "/triggers/" + token, fn);
    };
